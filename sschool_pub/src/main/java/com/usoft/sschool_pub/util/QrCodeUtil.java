...
public class QrCodeUtil {
   ...
   /* public static void readQrCode(InputStream inputStream) throws IOException {
    ...
    public void main(String[] args) throws IOException, WriterException {
        //createQrCode(new FileOutputStream(new File("d:\\qrcode.jpg")),"china is good",900,"JPEG");
        createQrCode("D:\\JAVA\\tomcat\\apache-tomcat-8.0.53\\webapps\\scenery\\upload\\images\\00005.jpg","JL00000009",900,"JPEG");
        //readQrCode(new FileInputStream(new File("src\\main\\webapp\\images\\1.jpg")));
    }
}
